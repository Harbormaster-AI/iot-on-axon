...
/**
 * <h2>GatewayCommandRestController as REST API</h2>
 * <p>
 * Implements Spring Controller command CQRS processing for entity Gateway.
 * </p>
  * Generated By Harbormaster
 *
 * Generated From
...
@CrossOrigin
@RestController
@RequestMapping("/GatewayCommand")
public class GatewayCommandRestController extends BaseSpringRestController {

	public GatewayCommandRestController( GatewayService service ) {
		this.service = service;
	}
	
    /**
     * Handles create a Gateway.
    ...
    public CompletableFuture<Void> delete( @RequestParam(required=true) UUID gatewayId  ) {
    	CompletableFuture<Void> completableFuture = null;
...
//************************************************************************
    ...
    private static final Logger LOGGER = Logger.getLogger(GatewayCommandRestController.class.getName());
