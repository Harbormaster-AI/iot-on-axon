...
/**
 * <h2>TenantCommandRestController as REST API</h2>
 * <p>
 * Implements Spring Controller command CQRS processing for entity Tenant.
 * </p>
  * Generated By Harbormaster
 *
 * Generated From
...
@CrossOrigin
@RestController
@RequestMapping("/TenantCommand")
public class TenantCommandRestController extends BaseSpringRestController {

	public TenantCommandRestController( TenantService service ) {
		this.service = service;
	}
	
    /**
     * Handles create a Tenant.
     * @param		Tenant	tenant
    ...
    public CompletableFuture<Void> delete( @RequestParam(required=true) UUID tenantId  ) {
    	CompletableFuture<Void> completableFuture = null;
...
//************************************************************************
    ...
    private static final Logger LOGGER = Logger.getLogger(TenantCommandRestController.class.getName());
