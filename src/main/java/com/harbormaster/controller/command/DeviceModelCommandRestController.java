...
/**
 * <h2>DeviceModelCommandRestController as REST API</h2>
 * <p>
 * Implements Spring Controller command CQRS processing for entity DeviceModel.
 * </p>
  * Generated By Harbormaster
 *
 * Generated From
...
@CrossOrigin
@RestController
@RequestMapping("/DeviceModelCommand")
public class DeviceModelCommandRestController extends BaseSpringRestController {

	public DeviceModelCommandRestController( DeviceModelService service ) {
		this.service = service;
	}
	
    /**
     * Handles create a DeviceModel.
    ...
    public CompletableFuture<Void> delete( @RequestParam(required=true) UUID deviceModelId  ) {
    	CompletableFuture<Void> completableFuture = null;
...
//************************************************************************
    ...
    private static final Logger LOGGER = Logger.getLogger(DeviceModelCommandRestController.class.getName());
