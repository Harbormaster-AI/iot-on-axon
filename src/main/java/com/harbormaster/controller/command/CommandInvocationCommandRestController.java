...
/**
 * <h2>CommandInvocationCommandRestController as REST API</h2>
 * <p>
 * Implements Spring Controller command CQRS processing for entity CommandInvocation.
 * </p>
  * Generated By Harbormaster
 *
 * Generated From
...
@CrossOrigin
@RestController
@RequestMapping("/CommandInvocationCommand")
public class CommandInvocationCommandRestController extends BaseSpringRestController {

	public CommandInvocationCommandRestController( CommandInvocationService service ) {
		this.service = service;
	}
	
    /**
     * Handles create a CommandInvocation.
    ...
    public CompletableFuture<Void> delete( @RequestParam(required=true) UUID commandInvocationId  ) {
    	CompletableFuture<Void> completableFuture = null;
...
//************************************************************************
    ...
    private static final Logger LOGGER = Logger.getLogger(CommandInvocationCommandRestController.class.getName());
