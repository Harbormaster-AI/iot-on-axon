...
/**
 * <h2>MessagingEndpointCommandRestController as REST API</h2>
 * <p>
 * Implements Spring Controller command CQRS processing for entity MessagingEndpoint.
 * </p>
  * Generated By Harbormaster
 *
 * Generated From
...
@CrossOrigin
@RestController
@RequestMapping("/MessagingEndpointCommand")
public class MessagingEndpointCommandRestController extends BaseSpringRestController {

	public MessagingEndpointCommandRestController( MessagingEndpointService service ) {
		this.service = service;
	}
	
    /**
     * Handles create a MessagingEndpoint.
    ...
    public CompletableFuture<Void> delete( @RequestParam(required=true) UUID messagingEndpointId  ) {
    	CompletableFuture<Void> completableFuture = null;
...
//************************************************************************
    ...
    private static final Logger LOGGER = Logger.getLogger(MessagingEndpointCommandRestController.class.getName());
