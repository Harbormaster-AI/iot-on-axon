...
/**
 * <h2>SimCardQueryRestController as REST API</h2>
 * <p>
 * Implements Spring Controller query CQRS processing for entity SimCard.
 * </p>
  * Generated By Harbormaster
 *
 * Generated From
...
public class SimCardQueryRestController extends BaseSpringRestController {
     ...
     */    
    @GetMapping("/load")
    public SimCard load( @RequestParam(required=true) UUID simCardId ) {
    	SimCard entity = null;
    ...
    public List<SimCard> loadAll() {                
    	...
    	try {
            ...
            LOGGER.log( Level.WARNING,  "failed to load all SimCards ", exc );
        	return null;
        }
