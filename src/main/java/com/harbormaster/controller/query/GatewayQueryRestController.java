...
/**
 * <h2>GatewayQueryRestController as REST API</h2>
 * <p>
 * Implements Spring Controller query CQRS processing for entity Gateway.
 * </p>
  * Generated By Harbormaster
 *
 * Generated From
...
public class GatewayQueryRestController extends BaseSpringRestController {
     ...
     */    
    @GetMapping("/load")
    public Gateway load( @RequestParam(required=true) UUID gatewayId ) {
    	Gateway entity = null;
