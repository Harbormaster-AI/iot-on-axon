...
/**
 * <h2>FirmwareReleaseQueryRestController as REST API</h2>
 * <p>
 * Implements Spring Controller query CQRS processing for entity FirmwareRelease.
 * </p>
  * Generated By Harbormaster
 *
 * Generated From
...
public class FirmwareReleaseQueryRestController extends BaseSpringRestController {
     ...
     */    
    @GetMapping("/load")
    public FirmwareRelease load( @RequestParam(required=true) UUID firmwareReleaseId ) {
     ...
     * @return		Set<FirmwareRelease>
     */
    @GetMapping("/")
    public List<FirmwareRelease> loadAll() {                
    	...
    	try {
            ...
            LOGGER.log( Level.WARNING,  "failed to load all FirmwareReleases ", exc );
        	return null;
        }
