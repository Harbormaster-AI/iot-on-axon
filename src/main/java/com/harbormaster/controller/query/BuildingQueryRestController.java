...
/**
 * <h2>BuildingQueryRestController as REST API</h2>
 * <p>
 * Implements Spring Controller query CQRS processing for entity Building.
 * </p>
  * Generated By Harbormaster
 *
 * Generated From
...
public class BuildingQueryRestController extends BaseSpringRestController {
     ...
     */    
    @GetMapping("/load")
    public Building load( @RequestParam(required=true) UUID buildingId ) {
    ...
    public List<Building> loadAll() {                
    	...
    	try {
            ...
            LOGGER.log( Level.WARNING,  "failed to load all Buildings ", exc );
        	return null;
        }
