...
/**
 * <h2>TelemetryStreamQueryRestController as REST API</h2>
 * <p>
 * Implements Spring Controller query CQRS processing for entity TelemetryStream.
 * </p>
  * Generated By Harbormaster
 *
 * Generated From
...
public class TelemetryStreamQueryRestController extends BaseSpringRestController {
     ...
     */    
    @GetMapping("/load")
    public TelemetryStream load( @RequestParam(required=true) UUID telemetryStreamId ) {
     ...
     * @return		Set<TelemetryStream>
     */
    @GetMapping("/")
    public List<TelemetryStream> loadAll() {                
    	...
    	try {
            ...
            LOGGER.log( Level.WARNING,  "failed to load all TelemetryStreams ", exc );
        	return null;
        }
