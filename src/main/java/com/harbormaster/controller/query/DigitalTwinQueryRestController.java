...
/**
 * <h2>DigitalTwinQueryRestController as REST API</h2>
 * <p>
 * Implements Spring Controller query CQRS processing for entity DigitalTwin.
 * </p>
  * Generated By Harbormaster
 *
 * Generated From
...
public class DigitalTwinQueryRestController extends BaseSpringRestController {
     ...
     */    
    @GetMapping("/load")
    public DigitalTwin load( @RequestParam(required=true) UUID digitalTwinId ) {
     ...
     * @return		Set<DigitalTwin>
     */
    @GetMapping("/")
    public List<DigitalTwin> loadAll() {                
    	...
    	try {
            ...
            LOGGER.log( Level.WARNING,  "failed to load all DigitalTwins ", exc );
        	return null;
        }
